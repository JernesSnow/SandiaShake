...
type RolColaborador = "Admin" | "Colaborador";
    ...
    try {
      ...
      setColaboradores(
        json.colaboradores.map((u: any) => ({
          ...
          nombre: u.nombre,
          email: u.correo,
          rol: u.rol === "ADMIN" ? "Admin" : "Colaborador",
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex flex-wrap gap-1.5 mt-2">
                    <span className={
                      ...
                      {c.rol === "Admin" && c.adminNivel
                        ? `Admin ${c.adminNivel === "PRIMARIO" ? "Primario" : "Secundario"}`
                        : c.rol}
                    </span>
                    <span className={
